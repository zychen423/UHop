...
def preprocess_WQ(data_path):
    with open(data_path, 'r') as f:
        ...
        for o_id, obj in enumerate(objs):
            ...
            print(question)
            parse = obj['Parses'][0]    # use only the first parse
...
if __name__ == '__main__':
    ...
    if args.mode == 'wq' or args.mode == 'wq_train1test2':
        included_relations = load_relation_list('wq')
    elif args.mode == 'sq':
        included_relations = load_relation_list('sq')
    else:
